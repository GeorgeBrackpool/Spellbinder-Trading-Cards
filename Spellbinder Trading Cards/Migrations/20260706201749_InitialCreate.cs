...
namespace SpellbinderTradingCards.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TradingCardGames",
                columns: table => new
                {
                    TradingCardGameId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TradingCardGames", x => x.TradingCardGameId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rarities_TradingCardGames_TradingCardGameId",
                        column: x => x.TradingCardGameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rarities_TradingCardGameId",
                table: "Rarities",
                column: "TradingCardGameId");
